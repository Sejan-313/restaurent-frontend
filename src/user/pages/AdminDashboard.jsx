...
const AdminDashboard = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const menuRes = await axios.get("https://restaurant-backend-11.onrender.com/api/menu");
      const reviewRes = await axios.get(
        "https://restaurant-backend-11.onrender.com/api/reviews/admin/all"
      );
  ...
  const toggleApproval = async (id) => {
    try {
      await axios.put(`https://restaurant-backend-11.onrender.com/api/reviews/admin/toggle/${id}`);
  ...
  const deleteReview = async (id) => {
    ...
    try {
      await axios.delete(`https://restaurant-backend-11.onrender.com/api/reviews/${id}`);
